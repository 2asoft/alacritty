...
| --- | ---: | ---: | --- | ---: | ---: | ---: |
| alacritty | yes | no | text-area-pixels, screen-size-cells, primary-device-attributes | 0 | 0 | 6 |
...
The full-frame Alacritty/Kitty comparison contains 11512 differing pixels.
