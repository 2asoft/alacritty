...
| Transport | File and shared-memory media ignore the direct-only chunk flag | Covered |
...
| Replacement | Failed or incomplete replacement preserves the old image until atomic commit | Covered, deliberate transactional extension |
...
| Placement | RIS clears visible graphics; Alacritty also clears graphics whose scrollback text RIS discards | Covered, host reset semantics |
...
| Quota | Non-visible placements are evicted before visible placements | Covered |
